...
router.get('/loha', function(req, res) {
  res.render('index2.hbs', { dropstyle: 'display:none;' });
});
//
...
router.post('/file_upload', function(req, res){
  ...
  res.render('index2.hbs', {message: "File has been uploaded! You can view the names variables by clicking the 'summary button'"});
